...
var mergeSort = function (array) {
  ...
  //return original array if only one element
  if (array.length <= 1) {
    return array;
  }
  ...
  // split input array into left and right halves
...
var merge = function (left, right) {
  ...
  var results = [];
  // index counters for both arrays
  var leftIndex = 0;
  var rightIndex = 0;

  // iterate over each array and push appropriate values into results
