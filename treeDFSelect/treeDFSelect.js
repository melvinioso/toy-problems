...
Tree.prototype.DFSelect = function(filter) {
  ...
  var recursiveHelper = (node, depth) => {
    // if node value matches filtered value or depth
    ...
    for (var i = 0; i < node.children.length; i++) {
      ...
      // call helper function on the child and increase depth
      recursiveHelper(child, depth + 1);
    }
  };

  // invoke on tree root
  recursiveHelper(this, 0);
  return results;
};
